...
public class UserController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        else if(action.equals("login"))
       {
           ...
           //     System.out.println("salt value"+salt);
                if (salt != null) {
                    ...
                    if (UserDB.selectUser(email, pwd, salt)){
                        ...
                        //    System.out.println("user email here is"+user);
                        String userType = user.getUserType();
                        //   System.out.println("user type here is"+userType);
                        ...
                        request.setAttribute("message", "Incorrect Username or Password.Please try again is here .");
                        url = "/login.jsp";
                    }
                }else {
        ...
        else if (action.equals("create")) {      try {
        ...
        else if (action.equals("activate")) {   try {
            // when user hits the link to activate account, this block get executed.
            String token = request.getParameter("token");
