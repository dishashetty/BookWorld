...
public class ProductDB {
	        ...
	        String query = "SELECT * from productlist";
	           ...
	           String PricePrimary = "";
	            ...
	            while (rs.next()) {
                    ...
                    //  System.out.println("curreny is----- "+currency);
                        
                      Price = currency.format(Integer.parseInt(PricePrimary));
                           // System.out.println("price is----- "+currency);
     ...
     public static product getProduct(String productID) throws ClassNotFoundException, SQLException{
        try{
              ConnectionPool pool = new ConnectionPool();
      Connection connection=pool.getConnection();
        PreparedStatement ps = null;
     ...
     public static int updateProduct(String productID, String productStatus, String productprice) throws ClassNotFoundException, SQLException{
        try{
              ConnectionPool pool = new ConnectionPool();
      Connection connection=pool.getConnection();
        PreparedStatement ps = null;
     //    ResultSet rs = null;
      ...
      public static int insertProduct(product Product) throws ClassNotFoundException, SQLException{
        try{
              ConnectionPool pool = new ConnectionPool();
      Connection connection=pool.getConnection();
        PreparedStatement ps = null;
